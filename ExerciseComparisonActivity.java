...
public class ExerciseComparisonActivity extends AppCompatActivity {
    ...
    TextView score;
    ImageView question;
    private ExerciseCompa mQuestion = new ExerciseCompa();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_comparison);
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    ...
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(ExerciseComparisonActivity.this, "จบเกมส์", Toast.LENGTH_LONG).show();
                        gameOver();
                    }
                ...
                .setPositiveButton("เริ่มใหม่",
                        new DialogInterface.OnClickListener(){
                            ...
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),ExerciseComparisonActivity.class));
                                finish();
                            }
                        })
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, ExerciseComparisonActivity.class));
    }

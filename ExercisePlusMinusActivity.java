...
public class ExercisePlusMinusActivity extends AppCompatActivity {
    ...
    TextView score;
    ImageView question;
    private ExercisePusMus mQuestion1 = new ExercisePusMus();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_plus_minus);
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    ...
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(ExercisePlusMinusActivity.this, "จบเกมส์", Toast.LENGTH_LONG).show();
                        gameOver();
                    }

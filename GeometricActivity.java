...
public class GeometricActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_gtric3;
        btn_gtric3=(Button)findViewById(R.id.btn_gtric3) ;
        btn_gtric3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(GeometricActivity.this,

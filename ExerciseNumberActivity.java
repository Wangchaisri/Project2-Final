...
public class ExerciseNumberActivity extends AppCompatActivity {
    ...
    TextView score;
    ImageView question;
    private ExerciseNum mQuestion = new ExerciseNum();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_number);
        ...
        score.setText("คะแนนก่อนบทเรียน:"+mscore);
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    ...
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(ExerciseNumberActivity.this, "จบเกมส์", Toast.LENGTH_LONG).show();
                        gameOver();
                    }
    ...
    private void gameOver(){
        ...
        Showscore.setMessage("คะแนนก่อนบทเรียนของน้องได้ "+ mscore+" คะแนน")
                .setCancelable(false)
                .setPositiveButton("เริ่มใหม่",
                        new DialogInterface.OnClickListener(){
                            @Override
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),ExerciseNumberActivity.class));
                                finish();
                            }
                        })
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, ExerciseNumberActivity.class));
    }

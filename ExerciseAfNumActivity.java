...
public class ExerciseAfNumActivity extends AppCompatActivity {
    ...
    TextView score;
    ImageView question;
    private ExerciseAfNum mQuestion = new ExerciseAfNum();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score.setText("คะแนนหลังบทเรียน:"+mscore);
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (choose1.getText()==mAnswer){
                    ...
                    updateQuestion(r.nextInt(mQuestionsLenght));
                    if (mscore==10) {
                        Toast.makeText(ExerciseAfNumActivity.this, "จบเกมส์", Toast.LENGTH_LONG).show();
                        gameOver();
                    }
    ...
    private void gameOver(){
        ...
        Showscore.setMessage("คะแนนหลังบทเรียนของน้องได้ "+ mscore+" คะแนน")
                .setCancelable(false)
                .setPositiveButton("เริ่มใหม่",
                        new DialogInterface.OnClickListener(){
                            @Override
                            public  void onClick(DialogInterface dialogInterface,int i){
                                startActivity(new Intent(getApplicationContext(),ExerciseAfNumActivity.class));
                                finish();
                            }
                        })
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, ExerciseAfNumActivity.class));
    }
